...
<body>
  ...
  <section>
    ...
    <form method="post" onsubmit="return confirmInsert();" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
      ...
      <label for="Comment_text">commen_text:</label>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $stmt = $connection->prepare("INSERT INTO comment (id, Post_id, User_id,Comment_text) VALUES (?, ?, ?, ?)");
      $stmt->bind_param("isss", $id, $Post_id, $User_id, $Comment_text);
    ...
    <table border="5">
      ...
      // SQL query to fetch data from comment table
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<tr>
                  ...
                  <td><a style='padding:4px' href='delete_comment.php?id=$id'>Delete</a></td> 
                  <td><a style='padding:4px' href='update_comment.php?id=$id'>Update</a></td> 
                </tr>";
        }
      } else {
