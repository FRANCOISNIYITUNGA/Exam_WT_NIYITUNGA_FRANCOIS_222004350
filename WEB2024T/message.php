...
<body>
  ...
  <section>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $stmt = $connection->prepare("INSERT INTO message (id, sender_id, receiver_id, content) VALUES (?, ?, ?, ?)");
      $stmt->bind_param("iiis", $id, $sender_id, $receiver_id, $content);
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<tr>
                  ...
                  <td>" . $row['content'] . "</td>
                  <td><a style='padding:4px' href='delete_message.php?id=$id'>Delete</a></td> 
                  <td><a style='padding:4px' href='update_message.php?id=$id'>Update</a></td> 
                </tr>";
        }
      } else {
