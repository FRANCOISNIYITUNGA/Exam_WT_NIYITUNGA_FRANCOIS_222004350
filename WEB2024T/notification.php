...
<h1>notification Form</h1>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO notification (id,user_id,content,date_created) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("iiss", $id,$user_id,$content,$date_created);
        ...
        $date_created = htmlspecialchars($_POST['date_created']); // Prevent XSS
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_notification.php?id=$id'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_notification.php?id=$id'>Update</a></td> 
                </tr>";
            }
        } else {
